    ...
    func setupConstraints() {
        NSLayoutConstraint.activate(
            [firsColorButton.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 200),
             ...
             firsColorButton.heightAnchor.constraint(equalToConstant: 150),
             firsColorButton.widthAnchor.constraint(equalToConstant: 150),
             
             secondColorButton.topAnchor.constraint(equalTo: firsColorButton.topAnchor),
             secondColorButton.leadingAnchor.constraint(equalTo: firsColorButton.trailingAnchor, constant: -15),
            
             secondColorButton.heightAnchor.constraint(equalToConstant: 150),
             secondColorButton.widthAnchor.constraint(equalToConstant: 150),
             ...
             resultsButton.heightAnchor.constraint(equalToConstant: 150),
